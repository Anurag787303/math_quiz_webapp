    ...
    <div className="popup-window">
      <div className="popup-content">
        ...
        <div className="popup-box" id="popup-box-t1">
          <div
            className="popup-result-t1"
            id="t1-q1"
            style={{
              backgroundColor: answers && answers.t1.q1 ? "#00900E" : "#FF3F3F",
            }}
          >
          ...
          <div
            ...
            id="t1-q2"
            style={{
              backgroundColor: answers && answers.t1.q2 ? "#00900E" : "#FF3F3F",
            }}
          >
        ...
        <div className="popup-box" id="popup-box-t2">
          <div
            className="popup-result-t2"
            id="t2-q1"
            style={{
              backgroundColor: answers && answers.t2.q1 ? "#00900E" : "#FF3F3F",
            }}
          >
          ...
          <div
            ...
            id="t2-q2"
            style={{
              backgroundColor: answers && answers.t2.q2 ? "#00900E" : "#FF3F3F",
            }}
          >
          ...
          <div
            ...
            id="t2-q3"
            style={{
              backgroundColor: answers && answers.t2.q3 ? "#00900E" : "#FF3F3F",
            }}
          >
          ...
          <div
            ...
            id="t2-q4"
            style={{
              backgroundColor: answers && answers.t2.q4 ? "#00900E" : "#FF3F3F",
            }}
          >
        ...
        <div className="popup-box" id="popup-box-t3">
          <div
            className="popup-result-t3"
            id="t3-q1"
            style={{
              backgroundColor: answers && answers.t3.q1 ? "#00900E" : "#FF3F3F",
            }}
          >
          ...
          <div
            ...
            id="t3-q2"
            style={{
              backgroundColor: answers && answers.t3.q2 ? "#00900E" : "#FF3F3F",
            }}
          >
          ...
          <div
            ...
            id="t3-q3"
            style={{
              backgroundColor: answers && answers.t3.q3 ? "#00900E" : "#FF3F3F",
            }}
          >
          ...
          <div
            ...
            id="t3-q4"
            style={{
              backgroundColor: answers && answers.t3.q4 ? "#00900E" : "#FF3F3F",
            }}
          >
      ...
      <div className="popup-footer">
        ...
        <div className="popup-done">
          <button onClick={handlePopupDone}>
            <h2>DONE</h2>
          </button>
        </div>
      </div>
