    ...
    return (
      <div className="question-container">
        <div className="question-info-container">
          ...
          <Link to="/dashboard">
            <div className="layout-quit-button">
              <h1>QUIT</h1>
            </div>
          </Link>
        </div>
        <div className="question-body-container">{children}</div>
        <div className="question-navigation-container">
          <div className="question-navigation">
            <div
              className="prev-arrow-icon"
              style={{ visibility: isLeftMost ? "hidden" : "visible" }}
            ...
            <div
              ...
              style={{ visibility: isRightMost ? "hidden" : "visible" }}
